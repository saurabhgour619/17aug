...
public class BookingDAOImpl implements BookingDAO {
	...
	private static final String SQL_GET_RESORT_BY_RESORT_BOOKING_ID = "SELECT * FROM resort_reservation WHERE r_reservation_number = ?";
	...
	public Resort bookResort(Resort resort, long guestID) {
		...
		try {
			...
			LOGGER.warn("BookingDAOImpl:Resort booking failed. Guest not found");
			return null;
		}
	...
	public Resort updateBookResort(Resort resort, long resortBookingId) {
		...
		try {
			...
			LOGGER.warn("BookingDAOImpl:Resort Update failed.Resort booking id not found");
			return null;
		}
	...
	public Resort cancelBookResort(long resortBookingId) {
		...
		try {
			...
			LOGGER.warn("BookingDAOImpl:Cancelling Resort failed.Resort booking id not found");
			return null;
		}
		return getResortByResortBookingID(resortBookingId);
	}
	...
	public Resort getResort(long rReservationNumber) {
		LOGGER.info("BookingDAOImpl:Executing getDining method.");
		Resort resort;
		try {
			resort = jdbcTemplate.queryForObject(SQL_GET_RESORT_BY_RESORT_BOOKING_ID,
